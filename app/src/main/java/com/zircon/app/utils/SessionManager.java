...
public class SessionManager {
    ...
    private static final String PREF_IS_SOCIAL_LOGIN = "is_social_login";
    ...
    public static void logoutUser() {
        ...
        editor.remove(PREF_IS_SOCIAL_LOGIN);
        editor.remove(PREF_LOG_IN_SOCIAL);
        editor.remove(PREF_LOG_IN_SOCIAL_TOKEN);
        editor.commit();
    }
    ...
    public static void setFBLoggedInUser(String SocialToken, User user, String token, Society society) {
        SharedPreferences sharedPreferences = ZirconApp.getAppContext().getSharedPreferences(PREF_FILE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean(PREF_IS_LOGGED_IN, true);

        editor.putBoolean(PREF_IS_SOCIAL_LOGIN, true);
        editor.putString(PREF_LOG_IN_SOCIAL, "Facebook");
        editor.putString(PREF_LOG_IN_SOCIAL_TOKEN, SocialToken);
    ...
    public static boolean isUserSocialLoggedIn() {
        SharedPreferences sharedPreferences = ZirconApp.getAppContext().getSharedPreferences(PREF_FILE, Context.MODE_PRIVATE);
        return sharedPreferences.getBoolean(PREF_IS_SOCIAL_LOGIN, false);
    }

    public static String getLogInSocialToken() {
        SharedPreferences sharedPreferences = ZirconApp.getAppContext().getSharedPreferences(PREF_FILE, Context.MODE_PRIVATE);
        return sharedPreferences.getString(PREF_LOG_IN_SOCIAL_TOKEN, null);
    }
    public static String getLogInSocial() {
        SharedPreferences sharedPreferences = ZirconApp.getAppContext().getSharedPreferences(PREF_FILE, Context.MODE_PRIVATE);
        return sharedPreferences.getString(PREF_LOG_IN_SOCIAL, null);
    }
